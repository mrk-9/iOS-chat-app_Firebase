...
/**
 * The minimum value text label. If not set, the default is min label text 18.
 */
@property (nonatomic, strong) IBInspectable NSString *minLabelText;

/**
 * The maximum value text label. If not set, the default is max label text 60+.
 */
@property (nonatomic, strong) IBInspectable NSString *maxLabelText;
